package GroovyBasics.stringDemo
...
class StringMethods {
    ...
    static void main(String[] args) {
        ...
        println("The contains value is " + s1.contains("Java"))
        ...
        println("The substring demo: " + s1.substring(3, 10))//it will print 10-1 = 9
        ...
        println("The Split demo: " + s1.split(" ")[0])
